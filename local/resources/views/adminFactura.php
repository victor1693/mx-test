                    ...
                    <div class="container-xl">
                        <div class="row g-2 align-items-center">
                            <div class="col">
                                ...
                                <h2 class="page-title">
                                    Factura:  <span class="text-primary" style="padding-left: 5px;"> <strong>#<?= $id;?></strong></span>
                                </h2>
                            </div>
                ...
                <div class="page-body">
                    <div class="container-xl">
                        <div class="row row-deck row-cards">
                                <?php if (count($facturas['result'])>0): ?>  
                                <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            Cliente: <span class="text-primary"><strong><?= $facturas['result'][0]->cliente;?></strong></span>
                                        </h3>
                                    </div>
                                    <table class="table card-table table-vcenter">
                                        ...
                                        <tbody>
                                            ...
                                            $imp = 0;
                                            $total = 0;
                                            foreach ($facturas['result'] as $key): ?>
                                            <?php 
                                            $sub = $sub + $key->sub_total;
                                            $imp = $imp + $key->total - $key->sub_total;
                                            $total = $total + ($key->sub_total + ($key->total - $key->sub_total));
                                            ?>
